...
Display_Output	
    ...
    POP {R0}                            ; Recupera o valor de R0
    LDR R1, =GPIO_PORTA_AHB_DATA_R 		; Le o endereço do data
	MOV R2, #2_11110000					; Seta todos os valores poss�veis de led
    PUSH {R0}                           ; Salva o valor R0
    AND R0, R2, R0						; Faz o AND para verificar todos os valores que ir�o acender
	STR R0, [R1]						; Escreve na porta o novo valor

    POP {R0}                            ; Recupera o valor de R0
	LDR R1, =GPIO_PORTQ_DATA_R 		    ; Le o endereço do data
	MOV R2, #2_00001111					; Seta todos os valores poss�veis de led
    PUSH {R0}                           ; Salva o valor R0
    AND R0, R2, R0						; Faz o AND para verificar todos os valores que ir�o acender
	STR R0, [R1]						; Escreve na porta o novo valor
