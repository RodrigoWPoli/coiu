...
; enable clock to GPIOF at clock gating register
			...
			MOV		R1, #GPIO_PORTM                 ;Seta o bit da porta F
...
EsperaGPIO  LDR     R1, [R0]						;L� da mem�ria o conte�do do endere�o do registrador
			MOV     R2, #GPIO_PORTM                 ;Seta os bits correspondentes �s portas para fazer a compara��o
...
; 2. Limpar o AMSEL para desabilitar a anal�gica
            ...
            LDR     R0, =GPIO_PORTM_AMSEL_R         ;Carrega o R0 com o endere�o do AMSEL para a porta J
...
; 4. DIR para 0 se for entrada, 1 se for sa�da
            ...
            MOV     R1, #2_0000111             		;PM0-PM2 para saída de controle do LCD
            STR     R1, [R0]						;Guarda no registrador PCTL da porta J da mem�ria
...
;			LDR     R0, =GPIO_PORT_PUR_R			;Carrega o endere�o do PUR para a porta J
